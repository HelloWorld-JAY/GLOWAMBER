$(function(){
	...
	// 정렬 있을시 색상바꾸기
	let arr = urlParams.get('arr');
	if(arr) {
		if(arr == 'korean') {
			$('#product_array > ul > li').css({"font-weight":""})
			$('#product_array > ul > li:nth-of-type(3)').css({"font-weight":"600"})
		}else if(arr == 'price') {
			$('#product_array > ul > li').css({"font-weight":""})
			$('#product_array > ul > li:nth-of-type(5)').css({"font-weight":"600"})
		}else {
			$('#product_array > ul > li').css({"font-weight":""})
			$('#product_array > ul > li:nth-of-type(1)').css({"font-weight":"600"})
		}
	}else {
		$('#product_array > ul > li').css({"font-weight":""})
		$('#product_array > ul > li:nth-of-type(1)').css({"font-weight":"600"})
